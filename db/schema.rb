...
ActiveRecord::Schema.define(version: 20170515125934) do
  ...
  create_table "comments", force: :cascade do |t|
    ...
    t.index ["star_rating_user"], name: "index_comments_on_star_rating_user", using: :btree
    t.index ["user_id", "hotel_id"], name: "index_comments_on_user_id_and_hotel_id", unique: true, using: :btree
